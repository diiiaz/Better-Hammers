...
// Copied and/or modified from: "https://github.com/Draylar/magna/blob/1.20.1/src/main/java/dev/draylar/magna/api/BlockFinder.java"
...
public interface BlockFinder {
    ...
    default List<BlockPos> findPositions(World world, PlayerEntity playerEntity, int radius, int depth) {
        ...
        if (blockHitResult.getType() == HitResult.Type.BLOCK) {
            ...
            if (item instanceof HammerTool) {
                origin = ((HammerTool) item).getCenterPosition(world, playerEntity, blockHitResult, handStack);
            }
